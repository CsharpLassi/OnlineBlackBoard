    ...
    $.colorPick.prototype = {
        ...
        init: function () {
            ...
            this.element.click(function (event) {
                ...
                self.show(self.element, event.pageX - offset.left, event.pageY - offset.top, self.options.pos);
        ...
        show: function (element, left, top, pos = null) {
            ...
            let colorPickHeight = $("#colorPick").height();
            let colorPickWidth = $("#colorPick").width();

            if (pos === 'top') {
                $("#colorPick").css('top', (top - colorPickHeight) + 'px');
            }
